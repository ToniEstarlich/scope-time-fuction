...
function Time_function() {//Definin a function and naming it
    var Time = new Date().getHours();//Defing a variable and giving it a
    var Reply;//Defining a variable an giving it  a
if (Time < 12 == Time > 0) {
...
//ENd of Else if Statements(Time_function)//